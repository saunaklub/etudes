...
void main() {
    ...
    outColor.rgb = mix(outColor.rgb, layer0.rgb, layer0.a);
    outColor.rgb = mix(outColor.rgb, layer1.rgb, layer1.a);
    outColor.rgb = mix(outColor.rgb, layer2.rgb, layer2.a);
